...
const API_CONFIG = {
    BASE_URL: ("TURBOPACK compile-time value", "https://resume-builder-backend-sdyq.onrender.com") || 'http://localhost:5001ss',
    TIMEOUT: 30000
};
const API_ENDPOINTS = {
    // Auth endpoints
...
apiClient.interceptors.response.use((response)=>{
    ...
    if (error.response?.status === 401) {
        ...
        if (!currentPath.includes('/login')) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearAuthData"])();
...
const signupUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('auth/signup', async (userData, { rejectWithValue })=>{
    try {
        ...
        if (token) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAuthData"])(token, user);
        }
...
const authSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    ...
    reducers: {
        ...
        loadUserFromStorage (state) {
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getToken"])();
            const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUser"])();
            if (token && user) {
...
"[project]/src/services/resume.service.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const resumeService = {
    ...
    getResumes: async (params = {})=>{
        try {
            ...
            const url = queryParams ? `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].RESUME.GET_ALL}?${queryParams}` : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].RESUME.GET_ALL;
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(url);
            return response;
        } catch (error) {
            throw error.response?.data || {
                message: error.message
    ...
    deleteResume: async (id)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].RESUME.DELETE(id));
            return response;
        } catch (error) {
            throw error.response?.data || {
                message: error.message
...
const __TURBOPACK__default__export__ = resumeService;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/resume.service.js [app-ssr] (ecmascript)");
;
;
const initialState = {
    resumes: [],
...
const createResume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/create', async (resumeData, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resumeService"].createResume(resumeData);
        return response.data.data;
    } catch (error) {
        const err = error;
...
const fetchResumes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/fetchAll', async (params = {}, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resumeService"].getResumes(params);
        return response.data.data;
    } catch (error) {
        const err = error;
...
const fetchResumeById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/fetchById', async (id, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resumeService"].getResumeById(id);
        return response.data.data;
    } catch (error) {
        const err = error;
...
const updateResume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/update', async ({ id, data }, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resumeService"].updateResume(id, data);
        return response.data.data;
    } catch (error) {
        const err = error;
...
const deleteResume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/delete', async (id, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resumeService"].deleteResume(id);
        return id;
    } catch (error) {
        const err = error;
...
const duplicateResume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/duplicate', async (id, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resumeService"].duplicateResume(id);
        return response.data.data;
    } catch (error) {
        const err = error;
...
const resumeSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    ...
    extraReducers: (builder)=>{
        ...
        // Duplicate Resume
        builder.addCase(duplicateResume.pending, (state)=>{
            state.createLoading = true;
            state.error = null;
...
const { setCurrentResume, clearCurrentResume, clearError } = resumeSlice.actions;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__75463815._.js.map