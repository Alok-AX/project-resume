...
function SettingsPage() {
    ...
    const { profile, loading, updateLoading, error, updateError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])((state)=>state.profile);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (error) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showError"])(error);
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$profileSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearProfileError"])());
        }
    }, [
        error
    ]);
    const handleInputChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$form$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createFormChangeHandler"])(setFormData);
    const handleImageUpload = (e)=>{
        const file = e.target.files?.[0];
        if (file) {
            // Validate using utility
            const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidImage"])(file, 2);
            if (!validation.valid) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showError"])(validation.error);
                return;
            }
            // Create preview
    ...
    const handleSave = async ()=>{
        try {
            const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$profileSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateProfile"])(formData)).unwrap();
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showErrorFromException"])(err, 'Failed to update profile');
        }
    };
    const handleCancel = ()=>{
        if (profile) {
...
//# sourceMappingURL=src_28d67025._.js.map