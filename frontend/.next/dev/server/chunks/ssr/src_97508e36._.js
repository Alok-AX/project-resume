...
function DashboardPage() {
    ...
    const handleFileChange = async (event)=>{
        ...
        if (result.success && result.fileName && result.dataUrl) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showSuccess"])('PDF uploaded successfully!');
            router.push('/dashboard/resumes/preview');
        } else {
            const errorMsg = result.error || 'Failed to upload PDF';
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showError"])(errorMsg);
...
//# sourceMappingURL=src_97508e36._.js.map