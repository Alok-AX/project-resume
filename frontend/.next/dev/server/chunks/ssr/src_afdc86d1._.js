module.exports = [
"[project]/src/utils/fileUpload.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$fileUpload$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/fileUpload.ts [app-ssr] (ecmascript)");
...
function DashboardPage() {
    ...
    const handleFileChange = async (event)=>{
        ...
        setIsUploading(true);
        setUploadError('');
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$fileUpload$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handlePdfUpload"])(file);
        if (result.success && result.fileName && result.dataUrl) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sessionStorage"].setUploadedPdf(result.fileName, result.dataUrl);
...
//# sourceMappingURL=src_afdc86d1._.js.map