...
"[project]/src/services/resume.service.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const resumeService = {
    ...
    getResumes: async (params = {})=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(url);
            return response;
        } catch (error) {
            throw error.response?.data || {
                message: error.message
    ...
    deleteResume: async (id)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].RESUME.DELETE(id));
            return response;
        } catch (error) {
            throw error.response?.data || {
                message: error.message
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/resume.service.js [app-client] (ecmascript)");
;
;
const initialState = {
    resumes: [],
...
const createResume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/create', async (resumeData, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resumeService"].createResume(resumeData);
        return response.data.data;
    } catch (error) {
        const err = error;
...
const fetchResumes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/fetchAll', async (params = {}, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resumeService"].getResumes(params);
        return response.data.data;
    } catch (error) {
        const err = error;
...
const fetchResumeById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/fetchById', async (id, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resumeService"].getResumeById(id);
        return response.data.data;
    } catch (error) {
        const err = error;
...
const updateResume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/update', async ({ id, data }, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resumeService"].updateResume(id, data);
        return response.data.data;
    } catch (error) {
        const err = error;
...
const deleteResume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/delete', async (id, { rejectWithValue })=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resumeService"].deleteResume(id);
        return id;
    } catch (error) {
        const err = error;
...
const duplicateResume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])('resume/duplicate', async (id, { rejectWithValue })=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$resume$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resumeService"].duplicateResume(id);
        return response.data.data;
    } catch (error) {
        const err = error;
...
//# sourceMappingURL=src_cf2f4f4b._.js.map